 ...
 *desafio.
 */
var teams = ['Flamengo', 'Palmeiras', 'Santos', 'Grêmio', 'Atletico-Pr']
 ...
 *    - Onde [POSIÇÃO] é a do por parâmetro e [NOME DO TIME] é o time
...
function convertToHex(cor) {
  switch (cor) {
    ...
    case 'black':
      ...
      break
    case 'white':
      console.log('O hexadecimal para a cor ' + cor + ' é #FFFFFFF.')
      break
    case 'yellow':
